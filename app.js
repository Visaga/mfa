...
app.post("/article", async(req, res) => {
	...
	res.redirect(`/article/${newBlog.urlExtention.replace(/ /g, "-")}`);
});
...
app.put("/article/:id",async( req, res)  => {
	...
	res.redirect("/article/" + updated.urlExtention.replace(/ /g, "-"));
...
app.get("/article/:urlextention", async(req, res) => {
